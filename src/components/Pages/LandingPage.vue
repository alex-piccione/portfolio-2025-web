...
<template>
    <p>
        ...
        It handles all fiat, crypto and stable currencies and displays their equivalent value in YOUR currency.<br />
        You can add deposits, withdrawals and transfers from/to your providers at any time, including past operations.<br />
